...
% For OLM, we used different parameters such as binsize, occThresh and different methods for determining the neuron firing threshold.
%%%%%%%%%%%%%%%%%%%% README end %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function demo_calciumImagingData_analysis_OLM(filefolder,mice)
% inputs: the name of file folder and mice
...
for j = 1:size(neuron.C,1)
    ...
    neuron.S(j,locs) = pks; % Here we used the peak of neuron.C to replace neuron.S as the extracted neuron.S have high background noise.
end
