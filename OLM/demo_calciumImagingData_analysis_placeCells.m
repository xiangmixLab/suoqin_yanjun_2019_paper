...
function demo_calciumImagingData_analysis_placeCells(filefolder,mice)
...
%{
[FiringRateAll,CountAll,CountTimeAll,CountTimeAll1,MeanFiringRateAll,InfoScoreAll,AmplitudeAll,binInfoAll] = calculating_FR_IS_parallel(neuronIndividuals,behavIndividuals,binsize,temp,thresh,countTimeThresh);
...
segments = place_cellsAll{2}; % only use place cells in baseline 2 for analysis
...
[sumAmplitudeAll,sumAmplitude_convAll,sumAmplitude_smoothingAll,sumAmplitudeObjectAll,sumAmplitudeObject_individualAll,posObjectsAll] = ...
    comparingFiringRateMultiConditionMultiObjects(behavIndividuals,AmplitudeAll,segments,CountTimeAll,binsize,binInfoAll,measures,plotting,smooth_index,sessions,colorscale,addindex,objname);
